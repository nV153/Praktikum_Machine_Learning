...
file_path = "playDataOfSimulationPlayerOne.csv"
...
def calculate_cards_played(row, full_deck, max_length):
    hand_cards = {row[f'hC{i}P1'] for i in range(13) if row[f'hC{i}P1'] != -100}
...
def determine_label(row):
    ...
    mapping = {3: 'trickCard2', 0: 'trickCard1', 1: 'trickCard0', 2: 'trickCard3'}
...
feature_columns = cards_played_columns + ['hCP0P1', 'hCP1P1', 'hCP2P1', 'hCP3P1', 'hCP4P1', 'hCP5P1', 'hCP6P1', 'hCP7P1', 'hCP8P1', 'hCP9P1', 'hCP10P1', 'hCP11P1', 'hCP12P1']
...
scaler_path_for_player_one = 'scaler_LSTM_player_one.pkl'  
dump(scaler, scaler_path_for_player_one)
...
torch.save(model.state_dict(), "lstm_model_player_one.pth")
