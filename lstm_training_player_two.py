...
file_path = "playDataOfSimulationPlayerTwo.csv"
...
def calculate_cards_played(row, full_deck, max_length):
    hand_cards = {row[f'hC{i}P2'] for i in range(13) if row[f'hC{i}P2'] != -100}
...
def determine_label(row):
    ...
    mapping = {0: 'trickCard2', 1: 'trickCard1', 2: 'trickCard0', 3: 'trickCard3'}
...
feature_columns = cards_played_columns + ['hCP0P2', 'hCP1P2', 'hCP2P2', 'hCP3P2', 'hCP4P2', 'hCP5P2', 'hCP6P2', 'hCP7P2', 'hCP8P2', 'hCP9P2', 'hCP10P2', 'hCP11P2', 'hCP12P2']
...
scaler_path_for_player_two = 'scaler_LSTM_player_two.pkl' 
dump(scaler, scaler_path_for_player_two)
...
torch.save(model.state_dict(), "lstm_model_player_two.pth")
