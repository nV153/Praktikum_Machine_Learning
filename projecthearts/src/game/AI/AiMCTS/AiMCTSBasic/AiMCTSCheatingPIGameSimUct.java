 ...
 * UCT is used in the selection phase. The simulation phase lasts until the end of the game.
 ...
 */
public class AiMCTSCheatingPIGameSimUct extends AiMCTSCheatingPIGameSim {

    public AiMCTSCheatingPIGameSimUct(){
        super();
    }
