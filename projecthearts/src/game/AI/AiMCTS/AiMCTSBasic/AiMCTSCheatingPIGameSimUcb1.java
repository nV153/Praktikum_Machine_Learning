 ...
 * UCB1 is used in the selection phase. The simulation phase lasts until the end of the game.
 ...
 */
public class AiMCTSCheatingPIGameSimUcb1 extends AiMCTSCheatingPIGameSim {

    public AiMCTSCheatingPIGameSimUcb1(){
        super();
    }
